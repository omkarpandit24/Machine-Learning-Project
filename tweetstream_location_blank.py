#Parts of this code has been adopted from UGCA class taken by Prof. Anitesh Barua
...
for i in range(tweets_num/100):
  url = "https://api.twitter.com/1.1/search/tweets.json?q='Alizee'&lang=en&count=100&result_type=recent&max_id="+str(id_list[2*i])
  response = twitterreq(url, "GET", parameters)
